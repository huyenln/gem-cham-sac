...
(function () {
  ...
  var STRINGS = {
    ...
    'nav.season':     { vi: `Season 01 đang diễn ra`, en: `Season 01 now on` },
    ...
    'footer.address':   { vi: `Số 69, Ngõ 12 Nguyễn Văn Huyên, Phường Nghĩa Đô, Hà Nội`, en: `No. 69, Lane 12 Nguyen Van Huyen, Nghia Do Ward, Hanoi` },
    ...
    'home.hero_cta1':      { vi: `Ghé thăm Season 01`, en: `Visit Season 01` },
    ...
    'home.season_label':   { vi: `Season 01 · đang mở cửa`, en: `Season 01 · now open` },
    'home.season_img_alt': { vi: `Không gian Gem Chạm Sắc`, en: `The Gem Chạm Sắc space` },
    'home.season_desc':    { vi: `Một không gian nhỏ để trải nghiệm sống bền vững, kết nối với cộng đồng những người yêu lối sống chậm, và bắt đầu hành trình "chạm xanh" cùng chúng mình.`, en: `A small space to experience sustainable living, connect with a community that loves slow living, and begin the "green touch" journey with us.` },
    'home.season_addr':    { vi: `Số 69, Ngõ 12 Nguyễn Văn Huyên<br>Phường Nghĩa Đô, Hà Nội`, en: `No. 69, Lane 12 Nguyen Van Huyen<br>Nghia Do Ward, Hanoi` },
    'home.season_until':   { vi: `Mở cửa đến tháng 10/2026`, en: `Open until October 2026` },
    ...
    'home.t1_h': { vi: `Túi đeo chéo`, en: `Crossbody bag` },
    'home.t1_p': { vi: `Vải caro · upcycled`, en: `Plaid fabric · upcycled` },
    'home.t2_h': { vi: `Gối Chắp Sắc`, en: `Patchwork cushion` },
    'home.t2_p': { vi: `Patchwork · vintage`, en: `Patchwork · vintage` },
    'home.t3_h': { vi: `Thảm Chắp Sắc`, en: `Patchwork rug` },
    'home.t3_p': { vi: `Patchwork · thủ công`, en: `Patchwork · handmade` },
    'home.t4_h': { vi: `Sổ kraft Gem`, en: `Gem kraft notebook` },
    'home.t4_p': { vi: `Giấy tái chế`, en: `Recycled paper` },
    ...
    'home.email_desc':       { vi: `Để chúng mình báo bạn khi có workshop mới, khi Season 02 mở cửa, hay khi có một dự án nho nhỏ vì môi trường cần thêm bạn đồng hành.`, en: `So we can let you know when there's a new workshop, when Season 02 opens, or when a small project for the planet needs another companion.` },
    ...
    'home.popup_footer': { vi: `❤ Hẹn gặp Udon ở Season 02?`, en: `❤ See Udon in Season 02?` },
    ...
    'story.cta_p':  { vi: `Season 01 đang mở cửa - một không gian nhỏ chờ bạn ghé thăm.`, en: `Season 01 is open — a small space waiting for your visit.` },
    ...
    'model.road_callout': { vi: `<strong>Season nào cũng cần bạn.</strong><br>Season 01 chỉ kéo dài 5 tháng. Dù bạn ghé qua ở season nào, bạn cũng là một phần quan trọng của hành trình này.`, en: `<strong>Every season needs you.</strong><br>Season 01 lasts only 5 months. Whichever season you drop by, you are an important part of this journey.` },
    ...
    'products.modal_cta':   { vi: `Mời các bạn qua cửa hàng xem & mua nhé!`, en: `Come visit our store to see & buy!` },
    ...
    'products.crossbody_h':  { vi: `Túi đeo chéo`, en: `Crossbody bag` },
    'products.crossbody_p':  { vi: `Vải caro upcycled`, en: `Upcycled plaid fabric` },
    ...
    'products.wallet_h':     { vi: `Ví & thẻ vải ghép`, en: `Patchwork wallet & card holder` },
    'products.wallet_p':     { vi: `Patchwork độc bản`, en: `One-of-a-kind patchwork` },
    ...
    'products.c2hand_p':  { vi: `Mỗi món một câu chuyện · bấm để xem`, en: `Each piece, its own story · tap to view` },
    ...
    'products.cgom_p':    { vi: `Sắc màu của thời gian · bấm để xem`, en: `Colors of time · tap to view` },

    /* Set quà category */
    'products.cat5_h':   { vi: `Set quà tặng`, en: `Gift sets` },
    'products.cat5_tag': { vi: `— trao gửi yêu thương`, en: `— give with love` },
    'products.cat5_lead':{ vi: `Những set quà nhỏ gói ghém từ đồ Gem — Bloom Charm, thiệp hoa, bookmark, scrunchie… cho dịp tốt nghiệp, sinh nhật, hay chỉ để tặng nhau.`, en: `Little gift sets wrapped from Gem pieces — Bloom Charm, flower cards, bookmarks, scrunchies… for graduations, birthdays, or just because.` },
    'products.setqua_h': { vi: `Set quà tặng`, en: `Gift set` },
    'products.setqua_p': { vi: `Bloom Charm · thiệp hoa · bookmark`, en: `Bloom Charm · flower card · bookmark` },

    /* ---------- VISIT (ghe-tham) ---------- */
    'visit.eyebrow':    { vi: `Ghé thăm`, en: `Visit` },
    'visit.hero_title': { vi: `Một nơi để bắt đầu.`, en: `A place to begin.` },
    'visit.hero_sub':   { vi: `Season 01 đang mở cửa — một không gian nhỏ chờ bạn đến.`, en: `Season 01 is open — a small space waiting for you.` },
    'visit.season_desc':{ vi: `Một không gian nhỏ để trải nghiệm sống bền vững, kết nối cộng đồng, và bắt đầu hành trình "chạm xanh".`, en: `A small space to experience sustainable living, connect with the community, and begin the "green touch" journey.` },
    'visit.season_until': { vi: `Mở cửa đến tháng 10/2026 · 5 tháng experience`, en: `Open until October 2026 · 5 months of experience` },
    ...
    'visit.addr_value': { vi: `Số 69, Ngõ 12 Nguyễn Văn Huyên<br>Phường Nghĩa Đô, Hà Nội`, en: `No. 69, Lane 12 Nguyen Van Huyen<br>Nghia Do Ward, Hanoi` },
    'visit.hours_label':{ vi: `Giờ mở cửa`, en: `Opening hours` },
    'visit.hours_value':{ vi: `Mời bạn liên hệ trước qua điện thoại<br>để chúng mình đón tiếp chu đáo nhất.`, en: `Please contact us by phone in advance<br>so we can welcome you at our best.` },
    ...
    'visit.email_p':    { vi: `Season 01 chỉ kéo dài 5 tháng — đây là cơ hội để bạn trải nghiệm và đồng hành cùng những điều tuy nhỏ bé nhưng đầy ý nghĩa.`, en: `Season 01 lasts only 5 months — a chance for you to experience and walk alongside things that are small yet full of meaning.` },
    'visit.email_list': { vi: `Chúng mình sẽ báo bạn khi:<br>· Có workshop mới<br>· Season 02 mở cửa<br>· Có dự án vì môi trường cần thêm bạn đồng hành`, en: `We'll let you know when:<br>· There's a new workshop<br>· Season 02 opens<br>· There's an environmental project that needs another companion` },
